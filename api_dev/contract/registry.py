...
REGISTRY = [
    ...
    {"domain": "Users", "operation": "Update own profile", "endpoint": "PATCH /api/v2/users/me/", "status": V2},
    {"domain": "Users", "operation": "Upload avatar", "endpoint": "POST /api/v2/users/me/avatar/", "status": V2},
    {"domain": "Users", "operation": "Remove avatar", "endpoint": "DELETE /api/v2/users/me/avatar/", "status": V2},
    ...
    {"domain": "Users", "operation": "Deactivate user", "endpoint": "POST /api/v2/users/{user_id}/deactivate/", "status": V2},
    {"domain": "Users", "operation": "Reactivate user", "endpoint": "POST /api/v2/users/{user_id}/reactivate/", "status": V2},
    ...
    {"domain": "Users", "operation": "Update assignment", "endpoint": "PATCH /api/role/user-role/{assignment_id}/", "status": LEGACY},
    {"domain": "Users", "operation": "Revoke assignment", "endpoint": "DELETE /api/role/user-role/{assignment_id}/", "status": LEGACY},
    ...
    {"domain": "Operations", "operation": "Operational exceptions", "endpoint": "GET /api/v2/operations/exceptions/", "status": V2},
    ...
    {"domain": "Domain actions", "operation": "Direct authorized action", "endpoint": "POST /api/v2/domain-actions/", "status": V2},
    ...
    {"domain": "Farms", "operation": "Upload farm image", "endpoint": "POST /api/v2/farms/{farm_id}/image/", "status": V2},
